 ...
 * Generated at: 2020-10-03 06:26:23 UTC
...
public final class item_002dparam_002dedit_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\r\n");
      out.write("<table cellpadding=\"5\" style=\"margin-left: 30px\" id=\"itemParamEditTable\" class=\"itemParam\">\r\n");
      out.write("\t<tr>\r\n");
      ...
      out.write("\t</tr>\r\n");
      out.write("</table>\r\n");
      out.write("<div  class=\"itemParameEditTemplate\" style=\"display: none;\">\r\n");
      ...
      out.write("\t\t\t\tTT.changeItemParam(node, \"itemParamEditTable\");\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t});\r\n");
      out.write("\t});\r\n");
      out.write("</script>\r\n");
      ...
      out.write("/item/param/query/itemcatid/\" + node.id,function(data){\r\n");
      out.write("\t\t\t\t  if(data.status == 200 && data.data){\r\n");
      out.write("\t\t\t\t\t  $.messager.alert(\"提示\", \"该类目已经添加，请选择其他类目。\", undefined, function(){\r\n");
      out.write("\t\t\t\t\t\t $(\"#itemParamEditTable .selectItemCat\").click();\r\n");
      out.write("\t\t\t\t\t  });\r\n");
      out.write("\t\t\t\t\t  return ;\r\n");
      out.write("\t\t\t\t  }\r\n");
      ...
      out.write("\t\t\t  var temple = $(\".itemParameEditTemplate li\").eq(0).clone();\r\n");
      out.write("\t\t\t  $(this).parent().parent().append(temple);\r\n");
      out.write("\t\t\t  temple.find(\".addParam\").click(function(){\r\n");
      out.write("\t\t\t\t  var li = $(\".itemParamEditTemplate li\").eq(2).clone();\r\n");
      ...
      out.write("\t\t });\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t$(\"#itemParamEditTable .close\").click(function(){\r\n");
      out.write("\t\t\t$(\".panel-tool-close\").click();\r\n");
      out.write("\t\t});\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t$(\"#itemParamEditTable .submit\").click(function(){\r\n");
      out.write("\t\t\tvar params = [];\r\n");
      out.write("\t\t\tvar groups = $(\"#itemParamEditTable [name=group]\");\r\n");
      ...
      out.write("\t\t\tvar url = \"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/item/param/update/\"+$(\"#itemParamEditTable [name=cid]\").val();\r\n");
      out.write("\t\t\t$.post(url,{\"paramData\":JSON.stringify(params)},function(data){\r\n");
      out.write("\t\t\t\tif(data.status == 200){\r\n");
      out.write("\t\t\t\t\t$.messager.alert('提示','更新商品规格成功!',undefined,function(){\r\n");
      out.write("\t\t\t\t\t\t$(\".panel-tool-close\").click();\r\n");
